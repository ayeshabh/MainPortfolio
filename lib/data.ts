...
export const projectsData = [
  ...
  },
  {
    ...
    imageUrl: tarshes,
    points:["I explored a dataset on San Francisco employee salaries to analyze correlations among job roles, age, income, and experience, aiming to understand their interrelationships. Using Python, I conducted a comprehensive analysis with data visualization and statistical techniques to uncover trends. I utilized essential Python functions for data extraction, cleaning, and analysis from a CSV file, demonstrating proficiency in data manipulation.","•Employed Python functions like info(), describe(), and NumPy's mathematical calculations (mean(), median(), std()) for comprehensive data insights.","•Identified disparities in salary distributions across departments and roles through visualizations and statistical summaries.","This project highlighted my ability to derive conclusions from complex datasets and my commitment to advancing in more sophisticated data-driven projects. It showcased my proficiency in Python for real-world data analysis, emphasizing the importance of data visualization techniques and statistical analysis in deriving actionable insights.","Reflecting on this project, I've gained valuable experience in leveraging Python for data analysis, particularly with San Francisco employee salary data. While I successfully utilized essential Python functions and techniques to extract meaningful insights, I aim to delve into more complex coding challenges in future projects. For instance, I've already begun experimenting with more advanced data visualization libraries and exploring statistical models to enhance the depth of my analyses. Moving forward, I look forward to tackling more intricate coding tasks, such as machine learning algorithms for predictive analytics, to further expand my skill set and contribute to more sophisticated data-driven projects."],
